...
This project demonstrates my ability to deliver a full-featured web application focused on user experience and business efficiency.`
  },
  {
    ...
    iconLists: ["/next.svg", "/react.svg", "/ts.svg", "/tailwindcss-logo.svg", "/redux.svg"],
    githubLink: "https://github.com/0zkan95/E-commerce_React-Redux",
    visitLink: "",
    des: ` STORE-JS - A Dynamic E-commerce Shopping Experience
STORE-JS is a comprehensive e-commerce web application I developed to provide a seamless and intuitive online shopping experience. The platform is designed to efficiently showcase products, highlight special offers, and enable users to easily find, select, and purchase items.
Key Features & Functionality:
...
Technical Stack:
This project leverages a modern JavaScript ecosystem for a feature-rich e-commerce platform:
...
The Little Lemon Restaurant is a modern and responsive web application I developed to provide users with a seamless and engaging dining experience. The platform is designed to showcase the restaurant's menu, offerings, and ambiance, while also allowing customers to make reservations and view their orders. `
  },
];
